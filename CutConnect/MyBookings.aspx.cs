...
public partial class MyBookings : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql = "SELECT s.name,b.appointment_datetime from booking as b, shop as s where b.shop_id = s.shop_id and b.userid = @userid";
    ...
    private void GenerateControls(string name, string appointment_datetime)
    {
        ...
        MyBookingsPanel.Controls.Add(span);
